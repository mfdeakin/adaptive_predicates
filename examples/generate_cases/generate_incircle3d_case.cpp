...
generate_incircle3d_case(std::mt19937_64 &rng) {
  const auto oriented_pts = generate_orient3d_case(rng);
  std::array<std::array<double, 3>, 5> incircle_pts;
  ...
  Shewchuk::insphere(incircle_pts[0].data(), incircle_pts[1].data(),
